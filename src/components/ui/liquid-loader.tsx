...
const LiquidLoading = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setHeights(prev => prev.map((height, index) => {
        ...
        const t = now * 0.001; // Much slower base speed
  ...
  return (
    <div className="flex items-end space-x-4 p-8 scale-75 md:scale-100">
        ...
        <div key={index} className="relative flex flex-col items-center">
          ...
          >
            ...
            <div 
              ...
              style={{
                transform: `translateY(${Math.floor(Math.sin(time * 0.003 + index * 0.5) * 1)}px) scaleY(${Math.floor(0.8 + Math.sin(time * 0.004 + index * 0.3) * 0.3)})pxs`
              }}
            />
            ...
            <div 
              ...
              style={{
                transform: `translateY(${Math.round(Math.sin(time * 0.002 + index * 0.5) * 2)}px)`,
