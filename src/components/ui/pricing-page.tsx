...
function PricingCard({ plan }: PricingCardProps) {
  ...
  return (
    <article className="relative flex w-full max-w-[19rem] flex-col rounded-[2rem] border border-white/15 bg-[#07111f] px-7 pb-8 pt-10 shadow-[0_16px_44px_rgba(2,8,23,0.34)] transition-colors duration-200 [.light_&]:border-[#1a8bff]/80 [.light_&]:bg-white [.light_&]:shadow-[0_10px_30px_rgba(37,99,235,0.08)]">
      ...
      <ul className="space-y-4 pt-6 text-[0.97rem] leading-6 text-slate-100 [.light_&]:text-[#08204d]">
        {features.map((feature) => (
          <li key={feature} className="flex items-start gap-3">
            <span className="mt-1 inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-[#38bdf8] [.light_&]:text-[#1565ff]">
      ...
      <button className="mt-8 inline-flex h-14 items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#0ea5e9] to-[#1565ff] px-6 text-base font-semibold text-white shadow-[0_10px_26px_rgba(21,101,255,0.18)] transition-transform duration-200 hover:translate-y-[-1px]">
