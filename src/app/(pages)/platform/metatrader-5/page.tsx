...
export default function MetaTrader5Page() {
  return (
    <>
      ...
      <main className="relative flex min-h-screen flex-1 flex-col overflow-hidden bg-[#040814] pt-24 [.light_&]:bg-[linear-gradient(180deg,#f7fbff_0%,#eef8ff_38%,#ffffff_100%)]">
        <div className="pointer-events-none absolute inset-0 -z-10">
          <div className="absolute inset-0 bg-[linear-gradient(180deg,#02050c_0%,#040814_28%,#060b15_64%,#070d17_100%)] [.light_&]:bg-[linear-gradient(180deg,#f7fcff_0%,#eef8ff_38%,#ffffff_100%)]" />
